...
\be
\label{eqn:pitch}
\Psi =  (25.6\pm0.5)^\circ - (10.8\pm0.8)^\circ w'_{\rm avg}, 
\ee
...
\ee
There is significant scatter in this plot, particularly were the GZ2 bulge sizes are small. Some of the scatter in this plot will be caused by the use by \citet{Simard2011} of models which include only two components, a bulge and a disk, which is problematic when the galaxy has a strong bar. \citet{Kruk2018} demonstrated that in bulge+disc+bar decompositions, there was a stronger correlations of $B/T$ with Galaxy Zoo consensus classifications of bulge size. As there is a positive correlation between an automated measure of bulge size and our GZ2 bulge prominence parameter, we will proceed to make use of the latter below. 
...
This is in clear contrast to the result hi-lighted in \citet{kennicutt1981} who show clearly that the \citet{sandagetammann1981} classifications of spiral type correlate best with pitch angle. 
