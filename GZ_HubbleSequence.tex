...
\section{Demographics of Local Galaxies} \label{demographics}
...
\end{figure*}
  ...
  It is only possible to identify spiral arms, bars and other disc features in disc galaxies which are sufficiently face-on for these to be visible. In a randomly oriented sample of disc galaxies, we expect to find $\sim 15\%$ of galaxies within $5\deg$ of perfectly edge-on. 
...
\section{Constructing a Hubble Sequence from Galaxy Zoo} \label{discussion}
